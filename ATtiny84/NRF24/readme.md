...
|--------------|------|--------------------|-----------------------------|
| Pin 1        | VCC  | Power              | 3.3V supply                 |
| Pin 2        | PB0  | I2C SCL (soft)     | nunchuk/OLED SCL            |
| Pin 3        | PB1  | I2C SDA (soft)     | nunchuk/OLED SDA            |
| Pin 4        | PB3  | RESET (Prog Reset) | not connected or 10kOhm VCC |
| Pin 5        | PB2  | INT0 / Serial RX   | Serial Adapter TX           |
| Pin 6        | PA7  | Serial TX          | Serial Adapter RX           |
| Pin 7        | PA6  | USI DI (Prog MOSI) | NRF24L01+ MISO (7)          |
| Pin 8        | PA5  | USI DO (Prog MISO) | NRF24L01+ MOSI (6)          |
| Pin 9        | PA4  | USI SCK (Prog SCL) | NRF24L01+ SCK (5)           |
| Pin 10       | PA3  |                    |                             |
...
USI is used in 3wires mode (SPI), to connect to NRF24L01.
When using USI for SPI use pin marking DI/DO/USCK.
MOSI/MISO marks refer to programmer connection, not SPI.
This is why USI DI is connected to NRF24L01 MISO, (NRF24L01 -> ATtiny84)
